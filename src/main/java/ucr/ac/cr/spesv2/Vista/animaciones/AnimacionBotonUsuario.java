...
//        System.out.println("ucr.ac.cr.spesv2.Vista.animaciones.BotonUsuario.mouseEntered()");
        ...
        boton.setIcon(super.renderEscala.escalarImageIcon(new javax.swing.ImageIcon(getClass().getResource("/img/botonUsuariosover.png"))));
...
//        System.out.println("ucr.ac.cr.spesv2.Vista.animaciones.BotonUsuario.mouseExited()");
        JButton boton = (JButton) arg0.getSource();
        boton.setIcon(super.renderEscala.escalarImageIcon(new javax.swing.ImageIcon(getClass().getResource("/img/botonUsuarios.png"))));
